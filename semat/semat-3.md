...
Currently we have ~902 lines of code written, most of it fetches data from the transportation database. We currently have 49 github commits for basic documentation, data fetching code, and this progress report. For other metrics, we have a method count of 21 and an average cyclomatic complexity of 1.31 (by function). The maximum cyclomatic complexity is 3. Our maximum depth of inheritance is 1 and our median is 0. 
