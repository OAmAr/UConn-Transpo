...
Currently we have ~2547 lines of code written, most of it fetches data from the transportation database. We currently have 66 github commits for basic documentation, data fetching code, and this progress report.
